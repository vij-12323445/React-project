...
const productsSlice = createSlice({
  ...
  initialState: {
    veg: [
      ...
      { id: 5, name: "Mushroom rice", price: 199, image: "Image/mushrom.png" },
      ...
      { id: 13, name: "kajju paneer Rice", price: 199, image: "Image/kajjupaneerrice.png" },
      { id: 14, name: "Gongura Rice", price: 89, image: "Image/gongurarice.png" },
      { id: 15, name: "Veg Dum Biriyani", price: 99, image: "Image/vegdumbiriyani.png" },
    ...
    nonveg: [
      ...
      { id: 11, name: "Leg piece", price: 69, image: "Image/legpiece.png" },
